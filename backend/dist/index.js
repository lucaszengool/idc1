    ...
    try {
        ...
        const projects2026 = [
            // IDC架构研发 - T-AIDC架构研发 (315万元)
            {
                ...
                projectName: "T-AIDC(含LC-MDC)架构研发",
                category: "IDC架构研发",
                ...
                owner: "carsonzeng",
                members: "",
                projectGoal: "研发模块底座、框架及密封组件等部件的结构研发与可行性验证",
                projectBackground: "T-AIDC(含LC-MDC)架构研发",
                projectExplanation: "1、研发模块底座、框架及密封组件等部件的结构研发与可行性验证；2、配电：研发小母线、电容补偿、≥400V高压技术提高配电系统效率及稳定性；3、暖通：研发氟-水/低水温CDU等空调设备，支持风液转换兼容设计；4、弱电：研发一体化交付弱电系统，集成配电、暖通等设备监控系统；5、水质：基于25年高校合作机理研究成果，研发液冷水质自动检测装置；",
                procurementCode: "TBD-2026-001",
                completionStatus: "未结项",
                relatedBudgetProject: "T-AIDC架构研发",
                budgetYear: "2026",
                budgetOccupied: 3150000,
                budgetExecuted: 0,
                orderAmount: 0,
                acceptanceAmount: 0,
                contractOrderNumber: "",
            ...
            },
            {
                ...
                owner: "dowpuyang",
                members: "",
                projectGoal: "IDC基础设施核心部件和整机的健康度评估",
                projectBackground: "暖通基础设施健康度和可靠性研究",
                projectExplanation: "IDC基础设施核心部件和整机的健康度评估",
                procurementCode: "TBD-2026-006",
                completionStatus: "未结项",
                relatedBudgetProject: "T-AIDC架构研发",
                budgetYear: "2026",
                budgetOccupied: 10000,
                budgetExecuted: 0,
                orderAmount: 0,
                acceptanceAmount: 0,
                contractOrderNumber: "",
            ...
            // IDC运营-研发 (65万元)
            {
                ...
                projectBackground: "液冷项目规模持续扩大，需要匹配新型液冷假负载完成验证测试工作",
            ...
            },
            {
                ...
                projectBackground: "中低压配电逻辑自动化测试需求",
