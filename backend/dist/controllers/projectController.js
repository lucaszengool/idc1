...
exports.batchImportProjects = exports.deleteProject = exports.updateProject = exports.getProjectById = exports.getProjects = exports.createProject = void 0;
...
// 批量导入项目预算数据
const batchImportProjects = async (req, res) => {
    try {
        ...
        for (const projectData of projects) {
            try {
                if (projectData.id) {
                    // 更新现有项目
                    const existingProject = await models_1.Project.findByPk(projectData.id);
                    if (existingProject) {
                    ...
                    const existingProject = await models_1.Project.findOne({ where: { projectCode: projectData.projectCode } });
...
exports.batchImportProjects = batchImportProjects;
