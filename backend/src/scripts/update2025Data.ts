...
import { TotalBudget, Project, BudgetExecution, BudgetAdjustment, MonthlyExecution, ProjectTransfer } from '../models';
...
async function main() {
  try {
    ...
    // Step 2: 更新2025年总预算
    console.log('\n📦 Step 2: 更新2025年总预算...');
    const [totalBudget, created] = await TotalBudget.findOrCreate({
      where: { budgetYear: '2025' },
      defaults: {
        budgetYear: '2025',
